...
echo head(array('title'=>$title,'bodyid'=>'items','bodyclass' => 'browse')); ?>

    <div id="primary">

        <h1><?php echo $title; ?> <?php echo __('(%s total)', total_records('item')); ?>
        ...
        <?php foreach (loop('items') as $item): ?>
            <div class="item hentry">
                <div class="item-meta">
                    <?php if ($text = metadata($item, array('Dublin Core', 'Type'))): ?>
                ...
                <?php echo fire_plugin_hook('public_items_browse_each'); ?>
